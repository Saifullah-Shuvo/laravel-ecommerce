...
@section('panel')
    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
        <h4 class="mb-sm-0">Add Sliders</h4>
    ...
    <form action="{{route('slider.store')}}" method="POST" enctype="multipart/form-data" id="image-upload">
        @csrf
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input type="text" name="title" class="form-control" id="product-title-input" value="" placeholder="Enter slider title">
                        ...
                        <div>
                            ...
                            <div id="ckeditor-classic">
                                <div>
                                    <textarea name="description" class="form-control" id="exampleFormControlTextarea5" rows="5" placeholder="Enter slider description"></textarea>
                                </div>
                                @error('description')
