...
@section('panel')
    ...
    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
        <h4 class="mb-sm-0">Coupons List</h4>
                            ...
                            <div class="col-sm">
                                <div class="d-flex justify-content-sm-end">
                                    <div class="search-box ms-2">
                                        <input type="text" class="form-control" id="searchProductList" placeholder="Search Coupons...">
                                ...
                                <ul class="nav nav-tabs-custom card-header-tabs border-bottom-0" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active fw-semibold" data-bs-toggle="tab" href="#productnav-all" role="tab">
                                            All <span class="badge bg-danger-subtle text-danger align-middle rounded-pill ms-1">{{ count($coupons) }}</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
                                    ...
                                    <table class="table table-nowrap mb-0">
                                        ...
                                        <tbody>
                                            ...
                                            @forelse ($coupons as $key => $data)
                                                <tr>
                                                    <td> {{ $key + 1 }} </td>
                                                    <td> {{ Str::limit($data->code, $limit = 15, $end = '...') }} </td>
                                                    <td>
                                                        @if ($data->discount_type == 'fixed')
                                                        <span class="badge rounded-pill bg-success-subtle text-info">Fixed</span>
                                                        @else
                                                        <span class="badge rounded-pill bg-danger-subtle text-info">Parcentage</span>
                                                        @endif
                                                    </td>
                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            ...
                                                            <div class="dropdown-menu">
                                                                ...
                                                                <a class="dropdown-item text-info edit" href="{{ route('coupon.edit', ['id' => $data->id]) }}">
                                                                        <i class="ri-pencil-fill"></i> Edit</a>

                                                                    @if ($data->status == 1)
                                                                        <a class="dropdown-item text-danger"
                                                                            href="{{ route('coupon.status.disable', ['id' => $data->id]) }}"><i
                                                                                class="bx bx-rotate-right"></i> Disable</a>
                                                                    @else
                                                                        <a class="dropdown-item text-success"
                                                                            href="{{ route('coupon.status.enable', ['id' => $data->id]) }}"><i
                                                                                class="bx bx-rotate-right"></i> Enable</a>
                                                                    @endif

                                                                <a class="dropdown-item text-danger" id="delete"
                                                                    href="{{ route('coupon.delete', ['id' => $data->id]) }}"
