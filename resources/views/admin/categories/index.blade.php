                ...
                <tbody>
                    @forelse ($categories as $key => $category)
                        <tr>
                            ...
                            <td>{{ $category->created_at->format('Y-m-d h:i:sa') }}</td>
                            <td>
                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu">
                                        <button class="dropdown-item text-info editBtn" type="button" data-id="{{ $category }}">
                    ...
                    <form method="POST" action="{{ route('category.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-xxl-12">
                                <div>
                                    <!-- Responsive Images -->
                                    <img src="{{ asset('admins/categoryimage/' . $category->category_image) }}"
...
;                let data = $(this).data();
                ...
                // modal.find('input[name="category_name"]').val(data.name);
            });
        });
    </script>
@endpush
