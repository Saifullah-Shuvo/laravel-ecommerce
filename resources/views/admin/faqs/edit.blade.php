                ...
                <div class="card">
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input type="text" name="question" class="form-control" id="product-title-input" value="{{ $faq->question }}">
                                @error('question')
                        ...
                        <div>
                            ...
                            <div id="ckeditor-classic">
                                <div>
                                    <textarea name="answer" class="form-control" id="exampleFormControlTextarea5" rows="5">{{ $faq->answer }}</textarea>
                                </div>
                                @error('answer')
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <select class="form-select" name="status" id="choices-publish-status-input" data-choices data-choices-search-false>
                                ...
                                <option value="0" {{ $faq->status == 0 ? 'selected' : '' }} >Unpublished</option>
                            </select>
                        </div>
                    </div>
                <!-- end card -->
